...
import { animeProviders } from "../scrapers";
...
export default class Extractor {
    ...
    public async extractMyCloud(url: string, result: Source): Promise<Source> {
        const proxy = getEnvVar("NINEANIME_RESOLVER") || "https://9anime.resolver.net";
        const proxyKey: string = getEnvVar("NINEANIME_KEY") || `9anime`;
